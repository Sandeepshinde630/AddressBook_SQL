...
update AddressBook set type = 'Friend'  where firstname in ('Christopher','David');
update AddressBook set type = 'Family'  where firstname in ('Ismael','Byron');
update AddressBook set type = 'Colleague'  where firstname = 'James'
select * from AddressBook